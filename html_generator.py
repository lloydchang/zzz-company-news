...
def generate_chatbot_html(news_data_for_js):
    ...
    <p class="timestamp">Last updated: {current_date}<br>Please reload this web page by pressing Command (⌘)-R on Mac or Ctrl+R on Windows keys if date appears older than a week.</p>
