...
for company in "Unaliwear" "BrainCheck" "Dermala" "Oralucent" "Flowly" "Rosy Wellness" "De Oro Devices" "Partum Health" "Fort Health" "RubyWell" "Atlantic Sea Farms" "VidaFuel" "Aloqia" "Refiberd" "Jiminy's" "Aeromutable"; do
