...
for company in 'Unaliwear' 'BrainCheck' 'Dermala' 'Oralucent' 'Flowly' 'Rosy Wellness' 'De Oro Devices' 'Partum Health' 'Fort Health' 'RubyWell' 'Atlantic Sea Farms' 'VidaFuel' 'Aloqia' 'Queen of Raw' 'Refiberd' 'Jiminys' 'Aeromutable'; do
